...
int input_read_parameters_species(struct file_content * pfc,
  ...
  /* Hanyu Read cdm equation of state parameters */
  class_read_double("a_nz", pba->a_nz);
  class_read_double("w_dm_0", pba->w_dm_0);
...
int input_default_params(struct background *pba,
  ...
  /* Hanyu Default values for cdm equation of state */
  pba->a_nz = 0.;
  pba->w_dm_0 = 0.;
