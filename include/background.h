...
struct background
{
  ...
  double a_nz;    /* Hanyu Scale factor for CDM equation of state */
  double w_dm_0;  /* Hanyu CDM equation of state parameter */
  ...
  int index_bg_p_cdm;        /**Hanyu< cdm pressure */
  int index_bg_w_cdm;        /**Hanyu< cdm equation of state */
